...
const Materials = () => {
    ...
    return(
       ...
       <div className='section'>
                    ...
                    <tbody>
                        {dataMaterial.map(item =>(
                            <tr key={item.ID}>
                                ...
                                <td><i className='mdi mdi-plus-circle icon-blue' onClick={handlePlusClick}></i></td>
                                <td></td>
                            </tr>
                        ))}
                    </tbody>
            ...
            {/* Muestra u oculta la tabla Material solicitado */}
            {showSecondTable &&
                <>
                <div className='section'>
                ...
                <table className="table table-materials is-fullwidth ">
                        <thead>
                            <tr >
                                ...
                                <th title="Cantidad" onClick={count}>Cantidad.</th>
                        ...
                        <tbody>
                            {dataMaterialSolicitado.map(item => (
                                <tr key={item.ID}>
                                    ...
                                    <td>
                                        {/* boton menos */}
                                        <i className='mdi mdi-minus-circle icon-blue' onClick={decrementsCounter} > </i>
                                        <i className='mdi mdi-remove-circle icon-blue'></i>
                                        {item.CANTIDAD}
                                        {/* boton mas */}
                                        <i className='mdi mdi-plus-circle icon-blue' onClick={incrementCounter}></i>
                                        <i className='mdi mdi-remove-circle icon-blue'></i>
                                    </td>
                                    <td title='Eliminar'>
                                        {/* boton/icon basurero */}
