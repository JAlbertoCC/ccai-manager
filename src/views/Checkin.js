      ...
      {showComponets ? (
        <CardComponent classExtra="opacity-card card-check">
          ...
          <ButtonComponent
            ...
            hdlOnClickEvent={() => goToLink("/visit-view")}
          />
        </CardComponent>
      ) : (
        <CardComponent classExtra="opacity-card card-check">
          ...
          <p className="dialog-view-check">
            {" "}
            Bienvenido{" "}
            {`${userInformation.name} ${userInformation.first_name} ${userInformation.second_name}`}{" "}
          </p>
          <br />
          <p className="dialog-view-check">
            {" "}
            Se ha registrado correctamente tu entrada a las{" "}
            {getDate("TIME_24_SIMPLE")}.{" "}
          </p>
          <br />
