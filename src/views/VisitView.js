          ...
          <CardComponent classExtra='opacity-card cardSam'>
            ...
            <div className="tabs is-large">
                <ul style={{ justifyContent: 'space-between' }}>
                  <li className={selectedTab ? 'is-active' : ''}>
                    <a onClick={() => handleTabClick(true)}>Entrada</a></li>
                  <li className={!selectedTab ?  'is-active' : ''}>
                    <a onClick={() => handleTabClick(false)}>Salida</a></li>
                </ul>
            </div>
            {/* contenedor de fecha */}
              ...
              <div> 
                <div className='columns content-forms'> 
                  ...
                  /> 
                   ...
                   Tu hora de entrada se registró correctamente a las {getDate(true)}. 
                  </p>
                  <br /> 
